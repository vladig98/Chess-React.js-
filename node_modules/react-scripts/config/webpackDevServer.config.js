...
module.exports = function (proxy, allowedHost) {
  ...
  return {
    ...
    setupMiddlewares: (middlewares, devServer) => {
      ...
      // Keep `evalSourceMapMiddleware` middlewares before `redirectServedPath` otherwise will not have any effect
      middlewares.unshift({
      ...
      if (fs.existsSync(paths.proxySetup)) {
        // This registers user provided middleware for proxy reasons
        middlewares.unshift({
          name: 'user-proxy-setup',
          middleware: require(paths.proxySetup)(devServer.app),
        });
      }
